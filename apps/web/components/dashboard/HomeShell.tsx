      ...
      <main className="p-6 md:p-10">
        <div className="mx-auto max-w-[76rem]">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2">
            <Link href="/marketplace" className="group rounded-[16px] border border-[#303030] bg-[#171717] p-6 no-underline transition-[border-color,transform] duration-150 hover:-translate-y-px hover:border-[#555]">
            ...
            <Link href="/publish" className="group rounded-[16px] border border-[#303030] bg-[#171717] p-6 no-underline transition-[border-color,transform] duration-150 hover:-translate-y-px hover:border-[#555]">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            <Link href="/purchases" className="rounded-[16px] border border-[#262626] p-5 no-underline hover:border-[#444]">
            ...
            <Link href="/analysis" className="rounded-[16px] border border-[#262626] p-5 no-underline hover:border-[#444]">
