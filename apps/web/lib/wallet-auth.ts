...
export type OwnershipAction = 'delist' | 'edit' | 'upload' | 'publish' | 'vote' | 'profile';
...
const ALLOWED_ACTIONS: readonly OwnershipAction[] = ['delist', 'edit', 'upload', 'publish', 'vote', 'profile'];
